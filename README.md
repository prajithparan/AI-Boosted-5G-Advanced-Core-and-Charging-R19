...
| 33.126 / 33.127 / 33.128 | Lawful Interception | **Core** | **Partial — still a deployment blocker.** The MDF2 mediation & delivery path is built and tested (`nfs/li-mdf`: LI_X1 provisioning, LI_X2 xIRI intake, LI_HI2 delivery to the LEMF; ADR-0373–0377). Still missing: the POIs 33.127 requires in AMF, SMF, UPF, UDM, SMSF, NEF, NWDAF and **§7.22 the CHF**, the NRF SIRF, the ADMF, and MDF3/HI3 (content of communication). A licensed operator still cannot deploy without these. |
