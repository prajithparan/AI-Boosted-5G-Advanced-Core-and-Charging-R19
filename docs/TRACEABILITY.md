...
## Lawful Interception -- X1 provisioning, NE server + keepalive, X2/X3 delivery client (ADR-0372), HI2/HI3 PS-PDU codec (ADR-0373), LI_HI2 mediation (ADR-0374)
...
| MDF2 process: X1-provisioned task store (which warrant a received PDU belongs to), Valkey state, wiring the receive server to the Delivery Function, fault reporting to the ADMF | TS 33.127 5.3.4; TS 33.128 5.3, 5.5 | -- | **not built** (the `nfs/li-mdf` increment) |
