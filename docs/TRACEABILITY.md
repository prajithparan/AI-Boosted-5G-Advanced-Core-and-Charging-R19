...
| MDF2 process: X2/X3 receiving server, X1-provisioned task store, HI2 transport to the LEMF (TS 102 232-1 6.4, TCP) | TS 33.127 5.3.4; TS 33.128 5.3, 5.5 | -- | **not built** (the `nfs/li-mdf` increment) |
